...
SRC_URI="mirror://sourceforge/project/unimediaserver/Official%20Releases/Linux/UMS-${PV}-Java7.tgz"
...
RDEPEND=">=virtual/jre-1.7.0
	...
	media-libs/libzen
	mencoder? ( >media-video/mplayer-1.1.1-r1[a52,alsa,bidi,cdio,dts,dv,dvd,dvdnav,enca,encode,faad,iconv,libass,mp3,theora,toolame,truetype,twolame,unicode,vorbis,x264,xvid] )
	tsmuxer? ( media-video/tsmuxer )
	ffmpeg? ( >=media-video/ffmpeg-2.8.7[aac,aacplus,bluray,bzip2,encode,faac,fontconfig,gpl,hardcoded-tables,iconv,libass,mp3,threads,truetype,vorbis,x264,xvid,zlib] )"
